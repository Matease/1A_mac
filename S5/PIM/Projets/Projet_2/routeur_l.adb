...
procedure routeur_l is

   procedure Initialiser_Table_Options (taille_cache : out Integer; politique : out Unbounded_String ; afficher_stat : out Boolean ;
...
begin
    Initialiser_Table_Options (taille_cache, politique , afficher_stat , fichier_table, fichier_paquet ,fichier_resultat);
