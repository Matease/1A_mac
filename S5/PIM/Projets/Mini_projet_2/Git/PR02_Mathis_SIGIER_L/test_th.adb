...
with Ada.Strings.Unbounded; use Ada.Strings.Unbounded;
    --! Les Unbounded_String ont une capacitÈ variable, contrairement au String
    --! pour lesquelles une capacitÈ doit Ítre fixÈe.
with TH;

procedure Test_TH is

    function Hachage_string (Cle : in Unbounded_String) return integer is
    begin
        return (length(Cle));
    end Hachage_string;
    
    package TH_String_Integer is
        new TH (T_Cle => Unbounded_String, T_Donnee => Integer, Capacite=>11, Hachage => Hachage_string);
    use TH_String_Integer;


    -- Retourner une chaÓne avec des guillemets autour de S
    ...
    -- guillemets sont ajoutÈes autour de la Unbounded_String
    -- Il s'agit d'un masquage de l'opÈrateur `&` dÈfini dans Strings.Unbounded
    ...
    -- Surcharge l'opÈrateur unaire "+" pour convertir une String
    -- en Unbounded_String.
    ...
    -- Attention, c'est ‡ l'appelant de libÈrer la mÈmoire associÈe en
    -- utilisant Vider.
    -- Si Bavard est vrai, les insertions sont tracÈes (affichÈes).
    ...
    begin
        ...
        for I in 1..Nb_Cles loop
            ...
            if Bavard then
                Put_Line ("AprËs insertion de la clÈ " & Cles (I));
    ...
    -- Tester suppression en commenÁant par les derniers ÈlÈments ajoutÈs
    ...
    begin
        ...
        for I in reverse 1..Nb_Cles loop
            ...
            Put_Line ("AprËs suppression de " & Cles (I) & " :");
            Afficher (Annuaire); New_Line;
    ...
    -- Tester suppression en commenÁant les les premiers ÈlÈments ajoutÈs
    ...
    procedure Tester_Supprimer_Un_Element is
        ...
        -- Tester supprimer sur un ÈlÈment, celui ‡ Indice dans Cles.
    ...
    procedure Tester_Remplacer_Un_Element is
        ...
        -- Tester enregistrer sur un ÈlÈment prÈsent, celui ‡ Indice dans Cles.
